...
class SearchResultParser:
    ...
    def parse_search_results(self, text_lines: List[str]) -> Tuple[List[BookDetail], List[ParseError]]:
        """
    ...
    def filter_results(self, results: List[BookDetail], 
                      author_filter: Optional[str] = None,
                      format_filter: Optional[str] = None,
                      min_quality: bool = True) -> List[BookDetail]:
        """
        ...
        if min_quality:
            ...
            non_archives = [r for r in filtered if r.format not in self.ARCHIVE_EXTENSIONS]
